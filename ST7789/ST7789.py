...
class ST7789(object):
    ...
    def __init__(self, spi_port=0, spi_device=0, spi_speed=40000000, spi_mode=0b11,
        rst=27, dc=25, led=24, width=ST7789_TFTWIDTH, height=ST7789_TFTHEIGHT,
        rotation=0, offset_left=0, offset_top=0):
        ...
        # Initialize display and turn on back light
        self.reset()
        self._init()
    ...
    def begin(self):
        ...
        if self._rotation == 90 or self._rotation == 270:
            ...
            display_width = self._height
            display_height = self._width
        else:
        ...
        self.data(0x00)
        self.data(display_width + self._offset_left - 1)
        
        self.command(0x2B)  # Row address set
        self.data(0x00)
        self.data(self._offset_top)
        self.data(0x00)
        self.data(display_height + self._offset_top - 1)
    ...
    def set_window(self, x0=0, y0=0, x1=None, y1=None):
        ...
        if self._rotation == 90:
            x0, y0, x1, y1 = y0, self._width-1-x1, y1, self._width-1-x0
        elif self._rotation == 180:
            x0, y0, x1, y1 = self._width-1-x1, self._height-1-y1, self._width-1-x0, self._height-1-y0
        elif self._rotation == 270:
            x0, y0, x1, y1 = self._height-1-y1, x0, self._height-1-y0, x1
    ...
    def clear(self, color=(0,0,0)):
        ...
        width, height = self._buffer.size
        self._buffer.putdata([color]*(width*height))
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("Pillow not found. Skipping image drawing example, fill screen with red instead.")
        ...
        # Turn off backlight and explicitly clean up GPIO resources
